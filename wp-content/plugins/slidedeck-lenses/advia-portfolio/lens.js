(function($){
    SlideDeckLens['advia-portfolio'] = function(slidedeck){
    	
    	var self = this;
        var ns = 'advia-portfolio';
    ...
    $(document).ready(function(){
        $('.lens-advia-portfolio .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-advia-portfolio')) == 'undefined' || $.data(this, 'lens-advia-portfolio') == null){
                $.data(this, 'lens-advia-portfolio', new SlideDeckLens['advia-portfolio'](this));
            }
        });
    });
})(jQuery);